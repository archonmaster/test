...
<div class="app-panel">
    ...
    <div class="uk-grid uk-grid-width-medium-1-6" uk-grid-margin uk-grid-match>
        ...
        <div class="uk-margin-bottom">
            ...
            <div class="uk-text-truncate">
                <a href="@route('/oauth2')">@lang('OAUTH2.0')</a>
            </div>
        </div>
        @endif
...
<div class="app-panel uk-margin-large-top">

    <div class="uk-text-left">
        <span class="uk-badge app-badge">@lang('Modules')</span>
    </div>
    ...
    <div class="uk-grid uk-grid-width-medium-1-6" uk-grid-margin uk-grid-match>
        ...
        @trigger('cockpit.settings.modules')

...
// ACL
$this("acl")->addResource('Collections', ['manage.collections', 'manage.entries', 'view.all.collections', 'view.all.entries']);
...
$app->on('admin.dashboard.aside', function() {
    ...
    $collections = $this->db->find('common/collections', ['limit'=> 20, 'sort'=>['created'=>1] ])->toArray();

    ...
    <form class="uk-form" data-ng-submit="save()" data-ng-show="collection">
        ...
        <div class="uk-grid">
            ...
            <div class="uk-width-1-4" data-ng-show="collection.fields && collection.fields.length">
                ...
                <div class="uk-margin">
                    <div class="uk-form-controls uk-margin-small-top">
                        <input type="checkbox" data-ng-model="collection.autoloader" /> @lang("Autoloader")
                    </div>
                    <div class="uk-form-controls uk-margin-small-top" ng-if="collection.autoloader">
                        <input data-ng-model="collection.autoloader_timeout" />
                    </div>
                </div>

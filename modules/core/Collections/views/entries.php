...
<div data-ng-controller="entries" ng-cloak>
    ...
    <nav class="uk-navbar uk-margin-bottom">
        <form class="uk-form" method="get" action="?nc={{ time() }}">
            <ul class="uk-navbar-nav">            
                <li class="uk-margin-right uk-margin-bottom" data-ng-repeat="field in collection.fields" data-ng-if="field.filter==true">
                    ...
                    <select name="filter[@@ field.name @@]" data-ng-if="field.type=='select'">
                        <option value="null">не выбран</option>
                        <option data-ng-repeat="option in field.options" value="@@ option @@" ng-selected="option=='@@ filter[field.name] @@'">@@ option @@</option>
                    </select>

            ...
            <div class="uk-width-medium-1-2">
                ...
                <div class="app-panel">
                    ...
                    <div class="uk-form-row">
                        ...
                        <input class="uk-width-1-1 uk-form-large" type="text" placeholder="@lang('Email subject')" data-ng-model="form.subject">
                    </div>
                    ...
                    <div class="uk-form-row">
                        <input type="checkbox" data-ng-model="form.recaptcha"> @lang('Use recaptcha')
                    </div>
